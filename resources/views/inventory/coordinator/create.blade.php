...
@section('content')
    <div class="container-fluid py-3">
        <div class="page-header">
            ...
            <div class="page-options d-flex">
                <a href="{{ route('coordinator.home') }}" class="btn btn-orange shadow-sm">
    ...
    <div class="container-fluid pb-3">
        <form action="{{ route('coordinator.inventory.create') }}" method="POST" class="card card-body shadow-sm border-0">
                ...
                <div class="offset-1 col-8">
                    <div class="form-row">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="location" class="form-control" disabled value="{{ $currentUser->location->name }}">
                        </div>
