...
@section('content')
    <div class="container-fluid py-3">
        <div class="page-header">
            ...
            <div class="page-subtitle">
                ...
                @if ($currentUser->hasAnyRole(['admin', 'webmaster']))
                    omtrent inzamelpunt <span class="font-weight-bolder">{{ ucfirst($location->name) }}</span>
                @endif
            </div>
    ...
    <div class="container-fluid pb-3">
        <div class="row">
            ...
            <div class="@if ($currentUser->hasAnyRole(['admin', 'webmaster'])) col-9 @else col-12 @endif"> {{-- content --}}
